...
// Generated by Apple Swift version 6.4 (swiftlang-6.4.0.33.1 clang-2100.3.33.1)
#ifndef CARRIER_STANDARD_LIBRARY_INTEGRATION_SWIFT_H
#define CARRIER_STANDARD_LIBRARY_INTEGRATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Carrier_Standard_Library_Integration",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
